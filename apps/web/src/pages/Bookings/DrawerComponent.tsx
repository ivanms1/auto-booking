...
function DrawerComponent({
  ...
  const onSubmit: SubmitHandler<BookingUpdateSchemaType> = async (data) => {
    ...
    bookingMutationUpdate.mutate({id, data: newObject}, {
      onSuccess: () => {
           reset()
           queryClient.invalidateQueries({queryKey: ['bookings']});
      ...
      onError: (error) => {
        const errorMessage = error.response?.data.message ? error.response?.data.message : 'Unnown Error'
    ...
    >
      {selectedBooking && (
        ...
        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
          ...
          <Button className={styles.submitButton} type='submit' size='lg'>
            Edit Booking
          </Button>
        </form>
